...
generate_rd_steps_XY2 <- function(steps_pollinator_i_year_plot_periodo_change_row,
                              number_random_steps,
  ...
  rd_turning_angle <-
    steps_lenght_turning_table$turning_angle[samples_rd_steps]
  
  previous_angles <- 
    rd_steps_pollinator_i_year_plot_periodo_change_row$previous_angle
  
  rd_angles_radians <- (previous_angles + rd_turning_angle)*pi/180

...
min_between_poll_space_finder <- function(Year.i,Bosque_i){
  ...
  # Load multilayer----------
  file_i <- paste0("results/gorbea/NN_networks/Bosque_",Bosque_i,"_Year_",Year.i,"_NN_intra_inter.rds")
...
plot_multilayer <- function(Year.i,Bosque_i,between_poll_space, r_ext){
  ...
  fitness_data2 <- read_csv(paste0("results/gorbea/foraging_Gorbea_",Year.i,".csv"))
...
png("figures/gorbea_Bosque_1_2020.png", width=1000*3, height = 500*3, res=300)
par(mar=c(0,0,0,14)+.1,xpd=TRUE)
plot_multilayer(2020,1,between_poll_space=10, r_ext= 160)
dev.off()


png("figures/gorbea_Bosque_2_2020.png", width=1000*3, height = 500*3, res=300)
par(mar=c(0,0,0,14)+.1,xpd=TRUE)
plot_multilayer(2020,2,between_poll_space=15, r_ext= 160)
dev.off()

png("figures/gorbea_Bosque_3_2020.png", width=1000*3, height = 500*3, res=300)
par(mar=c(0,0,0,14)+.1,xpd=TRUE)
plot_multilayer(2020,3,between_poll_space=15, r_ext= 100)
dev.off()

png("figures/gorbea_Bosque_4_2020.png", width=1000*3, height = 500*3, res=300)
par(mar=c(0,0,0,14)+.1,xpd=TRUE)
plot_multilayer(2020,4,between_poll_space=15, r_ext= 60)
dev.off()

png("figures/gorbea_Bosque_5_2020.png", width=1000*3, height = 500*3, res=300)
par(mar=c(0,0,0,14)+.1,xpd=TRUE)
plot_multilayer(2020,5,between_poll_space=15, r_ext= 60)
dev.off()

png("figures/gorbea_Bosque_1_2021.png", width=1000*3, height = 500*3, res=300)
par(mar=c(0,0,0,14)+.1,xpd=TRUE)
plot_multilayer(2021,1,between_poll_space=15, r_ext= 150)
dev.off()

png("figures/gorbea_Bosque_2_2021.png", width=1000*3, height = 500*3, res=300)
par(mar=c(0,0,0,14)+.1,xpd=TRUE)
plot_multilayer(2021,2,between_poll_space=15, r_ext= 200)
dev.off()

png("figures/gorbea_Bosque_3_2021.png", width=1000*3, height = 500*3, res=300)
par(mar=c(0,0,0,14)+.1,xpd=TRUE)
plot_multilayer(2021,3,between_poll_space=10, r_ext= 90)
dev.off()

png("figures/gorbea_Bosque_4_2021.png", width=1000*3, height = 500*3, res=300)
par(mar=c(0,0,0,14)+.1,xpd=TRUE)
plot_multilayer(2021,4,between_poll_space=15, r_ext= 60)
dev.off()

png("figures/gorbea_Bosque_5_2021.png", width=1000*3, height = 500*3, res=300)
par(mar=c(0,0,0,14)+.1,xpd=TRUE)
plot_multilayer(2021,5,between_poll_space=20, r_ext= 60)
dev.off()
